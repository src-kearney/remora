...
.preheader2:                                      ; preds = %1, %44
  %exitcond3.not = phi i1 [ false, %1 ], [ true, %44 ]
  %8 = phi i64 [ 0, %1 ], [ 8192, %44 ]
  %9 = getelementptr i8, ptr %6, i64 %8
  br label %.preheader

.preheader:                                       ; preds = %.preheader2, %.preheader
  %10 = phi i64 [ 0, %.preheader2 ], [ %43, %.preheader ]
  %.idx1 = shl i64 %10, 7
  ...
  br i1 %exitcond.not, label %44, label %.preheader, !llvm.loop !11

44:                                               ; preds = %.preheader
  br i1 %exitcond3.not, label %wrapped_broadcast_wrapped.exit, label %.preheader2, !llvm.loop !11

wrapped_broadcast_wrapped.exit:                   ; preds = %44
  ret ptr null
}
